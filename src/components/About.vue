...
<template>
    <!-- About Section Start -->
    <section id="about" class="pt-18 pb-16 bg-gray-100 scroll-m-30">
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10">Interested to grow with us?
                    </h3>
                    <p class="font-medium text-base text-secondary mb-6 lg:text-xl">Challenge us. We will happy to work
                        with you to create the really cool stuff.</p>
